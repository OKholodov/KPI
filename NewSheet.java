...
/*
    ...
    private static final String SQLFILE_GET_START_DATE_DATA  = "GET_START_DATE_DATA";
    private static final String SQLFILE_GET_END_DATE_DATA  = "GET_END_DATE_DATA";
*/
    ...
    private void printData() throws Exception {
        ...
        */
        ...
        printUXTable(
                new TableData(
                        ...
                        "UxTableComponent",
                        "Orders by Status",
                        KPISheetHelper.SQLFILE_GET_ORDER_BY_STATUS_T_HEAD,
                        KPISheetHelper.SQLFILE_GET_ORDER_BY_STATUS_T_DATA,
                        filterOrderStatus
                )
        );
        ...
        */
        ...
        //String script1 = "function getComponentValue(componentName) {return componentName.component.value;}";
        ...
        String returnValue = (String)inv.invokeFunction("getComponentValue",  sdObj);

        outputString.append("<script>");
        outputString.append("console.log(\"getComponentValue= " + returnValue + "\");\n");
        outputString.append("\n</script>");
        ...
        */
        ...
        /*
        outputString.append("<script>");
        outputString.append("console.log(\"temp3=\" + " + varComponent + ".component.value);\n");
...
*/
    ...
    private class TableData {
        ...
        public TableData(String divId, String componentId, String headerName, String sqlModelHeader, String sqlModelBody, Object[] filter) {
            this.divId = divId;
...
/*
    ...
    */
    ...
    private void printUXHeader() throws IOException {
        ...
        out.print("<script type='text/javascript' src='/solutions/titalia/sparkle/kpi/getparams.js'></script>\n");
...
*/
    ...
    private void printUXTable(TableData tableData) throws IOException {
        ...
        //test
        outputString.append("<div style=\"width: 80%;\">\n");
        outputString.append("<div id=\"DivTestTable\" class=\"ux-table\" style=\"margin-bottom: 30px\"></div>\n");
        outputString.append("</div>\n");
        ...
        List<KPISQLData> getOrderByStatusHeader = KPISQLData.getData(KPISheetHelper.findSQL(tableData.sqlModelHeader));
        ...
        // Model body
        List<KPISQLData> ordersList;
        ordersList = KPISQLData.getData(KPISheetHelper.findSQL(tableData.sqlModelBody),tableData.filter);
        ...
        for (KPISQLData sqlData : ordersList) {
    ...
    private String printUXDateField(String headerName, String dateDivId, String dateComponentId, String sqlModel) throws IOException {
        String dateModelId = "Model" + dateDivId;
        String varComponent = "var" + dateDivId;
        //String varSubscriber = "sbscr" + dateDivId;
        printHeader(headerName);

        StringBuilder outputString = new StringBuilder();

        outputString.append("<div style=\"width: 15%;\">\n");
        outputString.append("<div id=\"" + dateDivId + "\" style=\"margin-bottom: 30px\"></div>\n");
        outputString.append("</div>\n");

        outputString.append("<script>");

        outputString.append("function getComponentValue(componentName) {return componentName.component.value;}");
        ...
        //outputString.append(", \"value\": " + "\"" +  initialDate + "\"");

        // Close header
        outputString.append("    };");

        outputString.append("console.log(\"DateModel =  " + dateModelId + "\");");

        outputString.append("\nvar " + varComponent + " = uxNg2.createComponent(\"#" + dateDivId + "\", \"" + dateComponentId + "\", " + dateModelId + ");");
/*
        outputString.append("\nvar " + varSubscriber + " = " + varComponent + ".onFocus.subscribe((Event) => {console.log(\"TEST!!!!\")});");
        outputString.append("\nvar " + varSubscriber + " = " + varComponent + "._onFocus.subscribe((Event) => {console.log(\"TEST!!!!\")});");

        outputString.append("\nvar " + varSubscriber + " = " + varComponent + ".onBlur.subscribe((Event) => {console.log(\"TEST!!!!\")});");
        outputString.append("\nvar " + varSubscriber + " = " + varComponent + "._onBlur.subscribe((Event) => {console.log(\"TEST!!!!\")});");
*/

        /*
        outputString.append("console.log(\"temp2=\" + " + varComponent + ".component.value);\n");

        outputString.append("console.log(\"Params of " + varComponent + "\" );");
        outputString.append("\n" +
        " for (var key in " + varComponent + " ) { \n " +
        "  console.log( \"KEY: \" + key + \" = \" + " + varComponent + "[key] ); \n" +
        "}\n"
        );

        outputString.append("console.log(\"Params of " + varComponent + ".component \");");
        outputString.append("\n" +
                " for (var key in " + varComponent + ".component ) { \n " +
                "  console.log( \"KEY: \" + key + \" = \" + " + varComponent + ".component[key] ); \n" +
                "}\n"
        );
        */

        //outputString.append("\n" + varComponent + ".component.value = \"15.02.2018\";\n");
    ...
    private void printGridTable(TableData tableData) throws IOException {
        ...
        if (tableData.sqlModelBody.equals("GET_ORDER_BY_STATUS_T_DATA")) {
            ...
            ordersList = KPISQLData.getData(KPISheetHelper.findSQL(tableData.sqlModelBody),filter);
        }
        else {
            ordersList = KPISQLData.getData(KPISheetHelper.findSQL(tableData.sqlModelBody));
        }
