...
public class NewSheet extends UniSheet {
    ...
    public String htmlPage = "OrdersPage.html";

    //KPISheetHelper kpiHelper = new KPISheetHelper();

    /*
    NewSheet() {
        this.htmlPage = "OrdersPage.html";
    }

    NewSheet(String htmlPage) {
    ...
    */
    ...
    private void printData() throws Exception {
        ...
        out.print("<html> \n" +
                ...
                "    <script> \n" +
                "    $(function(){\n" +
                "      $(\"#includedContent\").load(\"/solutions/titalia/sparkle/kpi/" + htmlPage + "\"); \n" +
                "    });\n" +
                "    </script> \n" +
                "  </head> \n" +
                "\n" +
