...
public class NewSheet extends UniSheet {
    ...
    private void printData() throws Exception {
        ...
        */
/*
        sdObj = printUXDateField("Start date","StartDate", "UxDateFieldComponent", SQLFILE_GET_START_DATE_DATA, "10.02.2018");
        edObj = printUXDateField("End date","EndDate", "UxDateFieldComponent", SQLFILE_GET_END_DATE_DATA, "13.02.2018");
*/
        //"Error Orders"

        //Object[] filterErrOrders = new Object[]{"2018-01-30", "2018-02-02"};
/*
        printUXTable(
                new TableData(
                        "ErrOrders",
...
/*
    ...
    */
    ...
    private String printUXDateField(String headerName, String dateDivId, String dateComponentId, String sqlModel, String initialDate) throws IOException {
        ...
        List<SQLData> getDateModel = getData(findSQL(sqlModel));
...
*/
    ...
    private void printUXHeader() throws IOException {
        ...
        out.print("<script>jQuery.getScript(\"/solutions/"
                + "titalia/sparkle/kpi/newsheet.js\", function(){"
                + "attachInit();});</script>");
